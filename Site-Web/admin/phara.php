...
<!--               Alerts -->
    ...
    <section style="margin :50px ">
      <h2 style="margin-top:1%;text-align:center;"> <br> </h2>
      <div class="todolist" style="margin-top:1%;">
        <div class="column">
          ...
          <?php
            ...
            while ($row = mysqli_fetch_array($all_posts)) {
              echo "
                  ...
                  <td> ".$row['day']."</td>  
                  <td> ".$row['ville']."</td>
                 <td> <a href='update_phara.php?id=".$row['phara_id'].'&t_id='.$row['ville_id']."' style='float:right'><i class='fa fa-edit'></i></a>  </td>
                 <td> <a href='deletephara.php?id=".$row['phara_id']. '&t_id='.$row['ville_id']."' style='float:right'><i class='fa fa-trash'></i></a> </td>
                </tr>
