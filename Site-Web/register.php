                    ...
                    <div class="container-fluid">
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-2 col-lg-2">
                                <div class="logo">
                                    <a href="index.php"><img class="pdglogo" src="assets/img/logo/PDG LOGO.png"
                                            alt=""></a>
                                </div>
                            </div>
        ...
        <section id="formHolder">
            ...
            <div class="row">
                ...
                <div class="col-sm-6 brand">
                    <div class="heading">
                        <img class="connexionlogo" src="assets/img/logo/PDG LOGO FOOTER.png" alt="">
                    </div>
                </div>
                                ...
                                <div class="single-footer-caption mb-30">
                                    <div class="footer-tittle">
                                        <div class="footer-logo mb-20">
                                            <a href="index.php"><img class="pdglogofooter"
                                                    src="assets/img/logo/PDG LOGO FOOTER.png" alt=""></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
