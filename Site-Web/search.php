<?php
error_reporting(0);
$conn = mysqli_connect("localhost","root","","zentao");
if(count($_POST)>0) {
$ville=$_POST['ville'];

$result = mysqli_query($conn,"SELECT * FROM phara  where ville ='$ville' ");
}
?>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <section style="margin-top:2% ">
                    <h2 style="margin-top:5%;text-align:center;"><?php echo "$ville" ?></h2>
