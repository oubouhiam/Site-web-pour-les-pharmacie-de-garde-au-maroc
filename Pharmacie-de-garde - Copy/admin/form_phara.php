...
<!--               Alerts -->
    ...
    <div class="form" style="margin-top: 15%;"> 
      <form class="login-form" method="POST" action='<?php echo "insert_phara.php?id=".$id ?>'>
        ...
        <input type="addrsse" placeholder="addresse" name="addrsse"/>
        <input type="ville" placeholder="ville" name="ville"/>
